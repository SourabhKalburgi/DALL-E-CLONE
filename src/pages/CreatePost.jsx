  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Generate an 
        imaginative image through DALL-E AI and share it with the community</p>
